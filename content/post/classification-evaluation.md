...
Let's calculate precision for the `BERGF` class. We need the true positives, [mathjaxinline] M_{1,1} [/mathjaxinline], and the false positives, [mathjaxinline] M_{1,2} + M_{1,3} + M_{1,4} [/mathjaxinline]
<p align="center">
...
Let's calculate recall for the `BERGM` class. We need the true positives, [mathjaxinline] M_{2,2} [/mathjaxinline], and the false negatives, [mathjaxinline] M_{1,2} + M_{3,2} + M_{4,2} [/mathjaxinline]
<p align="center">
