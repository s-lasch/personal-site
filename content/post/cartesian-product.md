...
The cartesian product of two sets, $A$ and $B$, is denoted $A \times B$, and is defined as such: $$A \times B = \{(a,b) \ | \ a \in A, \ b\in B \}$$[^1] In plain English, it is the set of all possible ordered pairs whose first component comes from $A$, and whose second component comes from $B$[^1].
